      ...
      {isLoggedIn && (
        <div className="p-6">
          <button
            ...
            className="flex items-center justify-between w-full bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-900 shadow transition-all"
          >
            Logout
            <span className="bg-white text-gray-700 p-1 rounded-full">
